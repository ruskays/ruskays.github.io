...
$(document).ready(function () {
  ...
  //   x -= document.querySelector('.sliderwrapper').getBoundingClientRect().left;
  //   // Okay let's change our state
  //   scrollIt(x);
  // });
  // // Let's use this function
  // function scrollIt(x){
  //     let transform = Math.max(0,(Math.min(x,document.querySelector('.sliderwrapper').offsetWidth)));
