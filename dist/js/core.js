/*! For license information please see core.js.LICENSE.txt */ ! function (e) {
   var t = {};
   ...
   ! function (t, n) {
                     ...
                     return 1 === i && 0 === o ? function (e) {
                        ...
                        if (g) {
                           ...
                           if (h = [s ? g.firstChild : g.lastChild], s && y) {
                              for (b = (f = (c = (d = (u = (p = g)[w] || (p[w] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] || [])[0] === T && c[1]) && c[2], p = f && g.childNodes[f]; p = ++f && p && p[m] || (b = f = 0) || h.pop();)
                              ...
                              for (;
                                 (p = ++f && p && p[m] || (b = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++b || (y && ((d = (u = p[w] || (p[w] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] = [T, b]), p !== t)););
         ...
         function Ce(e, t, n, i, o, r) {
            return i && !i[w] && (i = Ce(i)), o && !o[w] && (o = Ce(o, r)), ce((function (r, s, a, l) {
               var c, d, u, p = [],
                  ...
                  v = n ? o || (r ? e : h || i) ? [] : s : g;
               if (n && n(g, v, a, l), i)
                  for (c = Te(v, f), i(c, [], a, l), d = c.length; d--;)(u = c[d]) && (v[f[d]] = !(g[f[d]] = u));
               if (r) {
                  if (o || e) {
                     if (o) {
      ...
      C.event = {
         ...
         add: function (e, t, n, i, o) {
            ...
            if (Q(e))
               for (n.handler && (n = (r = n).handler, o = r.selector), o && C.find.matchesSelector(re, o), n.guid || (n.guid = C.guid++), (l = g.events) || (l = g.events = Object.create(null)), (s = g.handle) || (s = g.handle = function (t) {
      ...
      function Re(e, t, n, i) {
         ...
         if (p && (r = (o = Te(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === o.childNodes.length && (o = r), r || i)) {
            ...
            if (a)
               for (d = s[s.length - 1].ownerDocument, C.map(s, Le), u = 0; u < a; u++) c = s[u], ve.test(c.type || "") && !K.access(c, "globalEval") && C.contains(d, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? C._evalUrl && !c.noModule && C._evalUrl(c.src, {
      ...
      C.Animation = C.extend(ft, {
            ...
            prefilters: [function (e, t, n) {
               ...
               for (i in n.queue || (null == (s = C._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function () {
                  ...
                  for (i in u && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = g && g.display) && (c = K.get(e, "display")), "none" === (d = C.css(e, "display")) && (c ? d = c : (pe([e], !0), c = e.style.display || c, d = C.css(e, "display"), pe([e]))), ("inline" === d || "inline-block" === d && null != c) && "none" === C.css(e, "float") && (l || (p.done((function () {
                        h.display = c
      ...
      C.extend(C.event, {
         trigger: function (e, t, i, o) {
            ...
            if (s = p = a = i = i || b, 3 !== i.nodeType && 8 !== i.nodeType && !Tt.test(m + C.event.triggered) && (m.indexOf(".") > -1 && (g = m.split("."), m = g.shift(), g.sort()), c = m.indexOf(":") < 0 && "on" + m, (e = e[C.expando] ? e : new C.Event(m, "object" == typeof e && e)).isTrigger = o ? 2 : 3, e.namespace = g.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), t = null == t ? [e] : C.makeArray(t, [e]), u = C.event.special[m] || {}, o || !u.trigger || !1 !== u.trigger.apply(i, t))) {
               ...
               for (r = 0;
                  (s = h[r++]) && !e.isPropagationStopped();) p = s, e.type = r > 1 ? l : u.bindType || m, (d = (K.get(s, "events") || Object.create(null))[e.type] && K.get(s, "handle")) && d.apply(s, t), (d = c && s[c]) && d.apply && Q(s) && (e.result = d.apply(s, t), !1 === e.result && e.preventDefault());
      ...
      Ft.href = kt.href, C.extend({
         ...
         ajax: function (e, t) {
            ...
            var i, o, r, s, a, l, c, d, u, p, f = C.ajaxSetup({}, t),
               h = f.context || f,
            ...
            function S(e, t, s, l) {
               ...
               }(f, k, s)), !u && C.inArray("script", f.dataTypes) > -1 && (f.converters["text script"] = function () {}), w = function (e, t, n, i) {
                  var o, r, s, a, l, c = {},
                     d = e.dataTypes.slice();
                  if (d[1])
      ...
      g.cors = !!Ut && "withCredentials" in Ut, g.ajax = Ut = !!Ut, C.ajaxTransport((function (e) {
         ...
         if (g.cors || Ut && !e.crossDomain) return {
            send: function (o, r) {
               ...
               t = function (e) {
                  return function () {
                     t && (t = i = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? r(0, "error") : r(a.status, a.statusText) : r(Vt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                        binary: a.response
                     } : {
                        text: a.responseText
   ...
   o = [], void 0 === (r = "function" == typeof (i = function () {
      ...
      var T = {
         fetch: function (l) {
            if (void 0 === l.maxTweets && (l.maxTweets = 20), void 0 === l.enableLinks && (l.enableLinks = !0), void 0 === l.showUser && (l.showUser = !0), void 0 === l.showTime && (l.showTime = !0), void 0 === l.dateFunction && (l.dateFunction = "default"), void 0 === l.showRetweet && (l.showRetweet = !0), void 0 === l.customCallback && (l.customCallback = null), void 0 === l.showInteraction && (l.showInteraction = !0), void 0 === l.showImages && (l.showImages = !1), void 0 === l.useEmoji && (l.useEmoji = !1), void 0 === l.linksInNewWindow && (l.linksInNewWindow = !0), void 0 === l.showPermalinks && (l.showPermalinks = !0), void 0 === l.dataOnly && (l.dataOnly = !1), o) i.push(l);
            else {
                  ...
                  computeStyle: {
                     ...
                     fn: function (e, t) {
                        ...
                        var s = void 0 !== r ? r : t.gpuAcceleration,
                           ...
                           m = void 0,
                           g = void 0;
                        if (g = "bottom" === u ? "HTML" === a.nodeName ? -a.clientHeight + d.bottom : -l.height + d.bottom : d.top, m = "right" === p ? "HTML" === a.nodeName ? -a.clientWidth + d.right : -l.width + d.right : d.left, s && h) c[h] = "translate3d(" + m + "px, " + g + "px, 0)", c[u] = 0, c[p] = 0, c.willChange = "transform";
                        else {
                           var v = "bottom" === u ? -1 : 1,
                              y = "right" === p ? -1 : 1;
   ...
   const {
      navigator: s
   } = r.window, a = -1 < s.userAgent.indexOf("MSIE ") || -1 < s.userAgent.indexOf("Trident/") || -1 < s.userAgent.indexOf("Edge/"), l = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(s.userAgent), c = (() => {
   ...
   function h() {
      f.length && (f.forEach((e, t) => {
         const {
            instance: n,
            oldData: i
         } = e, o = n.$item.getBoundingClientRect(), s = {
            width: o.width,
            height: o.height,
            top: o.top,
            bottom: o.bottom,
            ...
            wndH: u
         }, a = !i || i.wndW !== s.wndW || i.wndH !== s.wndH || i.width !== s.width || i.height !== s.height, l = a || !i || i.top !== s.top || i.bottom !== s.bottom;
   ...
   const v = function (e, t, ...n) {
      ...
      let o, r = 0;
      for (; r < i; r += 1)
         if ("object" == typeof t || void 0 === t ? e[r].jarallax || (e[r].jarallax = new g(e[r], t)) : e[r].jarallax && (o = e[r].jarallax[t].apply(e[r].jarallax, n)), void 0 !== o) return o;
      return e
   };
         ...
         t.prototype[e] = function (...t) {
            ...
            switch (i.pureOptions.threshold = i.$item.getAttribute("data-threshold") || "", e) {
               ...
               case "onScroll":
                  ...
                  let p = d,
                     f = u;
                  null !== i.options.thresholdY && d > i.options.thresholdY && (p = 0), null !== i.options.thresholdX && u > i.options.thresholdX && (f = 0), i.css(i.$item, {
         ...
         return window.PR_SHOULD_USE_CONTINUATION = !0,
            function () {
               var t = window,
                  ...
                  i = [
                     [n, "auto,case,char,const,default,double,enum,extern,float,goto,inline,int,long,register,restrict,short,signed,sizeof,static,struct,switch,typedef,union,unsigned,void,volatile"], "catch,class,delete,false,import,new,operator,private,protected,public,this,throw,true,try,typeof"
                  ],
                  ...
                  ! function () {
                     for (var o = e.concat(t), r = [], s = {}, a = 0, l = o.length; a < l; ++a) {
                        var c = o[a],
                           d = c[3];
                        if (d)
                           for (var u = d.length; --u >= 0;) i[d.charAt(u)] = c;
                        var p = c[1],
                           f = "" + p;
               ...
               function C(e) {
                  ...
                  try {
                     var d = (n = e.sourceNode, i = e.pre, o = /(?:^|\s)nocode(?:\s|$)/, r = [], s = 0, a = [], l = 0, function e(t) {
                        ...
                        u = d.sourceCode;
                     e.sourceCode = u, e.spans = d.spans, e.basePos = 0, T(c, u)(e),
                        function (e) {
               ...
               function S(e, n) {
                  ...
                  for (var s = [r("pre"), r("code"), r("xmp")], a = [], l = 0; l < s.length; ++l)
                     for (var c = 0, d = s[l].length; c < d; ++c) a.push(s[l][c]);
                  s = null;
                  var u = Date;
                  u.now || (u = {
                     now: function () {
               ...
               x(y, ["default-code"]), x(g([], [
                  ...
                  ["lang-in.tag", /^(<\/?[a-z][^<>]*>)/i]
               ]), ["default-markup", "htm", "html", "mxml", "xhtml", "xml", "xsl"]), x(g([
                  ["pln", /^[\s]+/, null, " \t\r\n"],
                  ["atv", /^(?:\"[^\"]*\"?|\'[^\']*\'?)/, null, "\"'"]
               ], [
                  ["tag", /^^<\/?[a-z](?:[\w.:-]*\w)?|\/?>$/i],
         ...
         var n = {
            ...
            init: function () {
               ...
               var n = e("#theme").attr("href").substring(5),
                  i = (n = (n = n.substring(0, n.length - 4)).split("-"))[1],
                  o = e("#color-switcher");
   ...
   class f {
      ...
      onAPIready(e) {
         if ("youtube" === this.type && (void 0 !== o.a.YT && 0 !== o.a.YT.loaded || c ? "object" == typeof o.a.YT && 1 === o.a.YT.loaded ? e() : u.done(() => {
            ...
            if (void 0 !== o.a.Vimeo || d) void 0 !== o.a.Vimeo ? e() : p.done(() => {
               e()
            });
            else {
               d = 1;
